...
import com.example.myapplication.ui.activity.EditIngredientActivity;
...
//        }
        ...
        holder.deleteButton.setOnClickListener(v -> {
            ...
            if (currentPosition != RecyclerView.NO_POSITION) {
                apiRequest.deleteIngredientByName(ingredient.getName(), new ApiRequest.ApiDeleteListener() {
                    @Override

...
public class Ingredient implements Serializable {
    ...
    public Ingredient(Long id, String name, int quantity, String unit, String intakeDate, Calendar expirationDate, String storageLocation, int imageResId) {
        this.id = id;
        this.name = name;
    ...
    public Ingredient(String name, int quantity, String unit, String intakeDate, Calendar expirationDate, String storageLocation, int imageResId) {
        this(null, name, quantity, unit, intakeDate, expirationDate, storageLocation, imageResId);
    }
